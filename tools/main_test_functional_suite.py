...
TEST_MODULES = [
    ...
    "quant_system.test_live_runtime_weekend",
    "quant_system.test_live_runtime_boundaries",
    "quant_system.test_live_strategy_eval",
    "quant_system.test_live_order_sizing",
    ...
    "quant_system.test_symbol_research_reporting",
    "quant_system.test_research_cli",
